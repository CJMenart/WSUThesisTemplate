...
\newcommand{\institution}{Wright State University} % Doubting you will
                                % change this.
%OhioLink submission requires thesis title in ALL UPPERCASE
\newcommand{\thesistitle}{SOME REALLY GREAT TITLE THAT PROVIDES A
  CON\-CISE VIEW OF THE TOPIC YOUR THESIS WILL ADDRESS} % Needs a line break
...
\newcommand{\graduateSchoolDean}{Subhashini Ganapathy}
\newcommand{\graduateSchoolDeanEducation}{Ph.D.}
\newcommand{\graduateSchoolDeanTitle}{Dean of the College of Graduate Programs and Honors Studies}
...
%========================
% Start editing below.
% Note: For submission to OhioLink, WSU.sty needs modified to correctly display the date on Abstract Page (to the date of your defense)
% 	PhD date change at line 123, Masters date change at line 194
%========================
...
\clearpage \phantomsection\ %used to correctly anchor hyperlinks, just
			   ...
			   %note: \phantomsection\ may cause an empty page space before Bibliography, 
			   %	  incorrectly displaying start of page for the TOC
